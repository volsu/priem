...
class User extends \yii\db\ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            'id' => Yii::t('app', 'ID'),
            'object1' => Yii::t('app', 'Балл 1'),
            'object2' => Yii::t('app', 'Балл 2'),
            'object3' => Yii::t('app', 'Балл 3'),
            ...
            'priority' => Yii::t('app', 'Приоритет по данной ООП'),
            'order' => Yii::t('app', 'Order'),
            'oop_base' => Yii::t('app', 'Oop Base'),
            'is_expelled' => Yii::t('app', 'Is Expelled'),
            'enrollee_code' => Yii::t('app', 'Enrollee Code'),
            'enrollee_name' => Yii::t('app', 'ФИО абитуриента'),
            'total_balls' => Yii::t('app', 'Общий балл'),
            ...
            'cg_form' => Yii::t('app', 'Форма обучения:'),
            'cg_oop_code' => Yii::t('app', 'Cg Oop Code'),
            'cg_oop_name' => Yii::t('app', 'Специальность/направление подготовки:'),
            'cg_level' => Yii::t('app', 'Уровень образования:'),
            'cg_base' => Yii::t('app', 'Тип приема:'),
